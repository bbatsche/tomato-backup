ScriptInfo_backup_nvram_encapsulated_functions() {
    SCRIPT_NAME="Backup NVRam (Encapsulated)"; SCRIPT_VERSION="3.0"; SCRIPT_DATE="2020-02-27"; SCRIPT_AUTHER="Ben Batschelet"; SCRIPT_AUTHER_CONTACT="ben.batschelet@gmail.com"
...
# ----------------------------------------------------------------------------------------------------------------------
# General Usage: backupNVRamEcapsulated "backup_task_name" "backup_destination_directory" "backup_destination_filename_prefix" "backup_note" "backup_destination_filename_suffix" "backup_retention_number" "nvram_filter_in" "nvram_filter_out"
# ======================================================================================================================
# Notes:
